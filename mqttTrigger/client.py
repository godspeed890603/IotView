...
# 定期發送請求消息
def send_request_periodically(service_name, payload, interval=3):
    while True:
...
request_thread = threading.Thread(target=send_request_periodically, args=(service_name, payload, 3))
